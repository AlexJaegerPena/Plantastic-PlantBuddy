...
- ⛅ 3-Tage-Wetterprognose für Pflegeplanung  
...
**Plantastic** is an iOS app that helps you take care of your plants optimally – with personalized watering reminders, location-based weather, and comprehensive plant information. 🌱☀️
...
- 🪴 **Discover Plants**  
  Explore an extensive database of thousands of plant species – including care instructions, location, light requirements, and watering intervals.

- 🌟 **Save Favorites**  
  Add your favorite plants to your digital “garden” for quick access to all important information.

- 💧 **Individual Watering Plans**  
  Track when you last watered and get recommendations for the next watering.

- 📍 **Weather Integration**  
  Automatically adapt your watering schedule to local weather conditions.

- 🔔 **Push Notifications**  
  Get reminded when your plants are thirsty.

- 📆 **Calendar Overview**  
  Keep track of all upcoming watering tasks.

- 🔐 **User Profiles with Firebase**  
  Securely save your plants, watering data, and settings in the cloud.
...
| Technology       | Use Case                                                                      |
|------------------|-------------------------------------------------------------------------------|
| **Swift & SwiftUI** | Modern app development with declarative UI                                    |
| **WeatherAPI**      | Location-based weather for smart watering decisions                          |
| **Perenual API**    | Plant database with care info, images & location requirements                |
| **Firebase**        | Authentication, cloud storage & real-time data                                 |
| **@AppStorage**     | Local storage of UI states (e.g., Dark Mode, intro screens)                   |
...
- iOS 18 or newer  
- Internet connection (for API access & Firebase)  
...
### 📍 [WeatherAPI](https://api.weatherapi.com/)  
- Location-specific weather data (temperature, rain, humidity) to optimize watering recommendations.

### 🌱 [Perenual API](https://perenual.com/api/)  
- Comprehensive plant info: watering intervals, light requirements, flowering time, location needs, and more.

### 🔐 [Firebase](https://firebase.google.com/)  
- Authentication & user management  
- Saving favorites, watering data & reminders  
...
- ⛅ 3-day weather forecast for care planning  
- 🔊 Sound feedback for better UX  
- 🌿 Smart care tips (fertilizing, repotting, pruning)  
- 💡 General gardening tips & tricks  
- 📷 Save your own plant photos & notes  
- 📸 Plant recognition via camera  
- 🏆 Milestones & gamification for long-term motivation  
- 🎯 Collect credits & e.g., plant trees  
- 🔗 Product recommendations directly in the app  
- 📴 Offline mode for maximum flexibility

---

## 💚 Enjoy caring for your plants with Plantastic!
